...
urlpatterns = [
    ...
    path('get-rfq-list/', views.GetRFQList.as_view(), name="get-rfq-list"),
    path('get-rfq-items/<int:rfq_id>/', views.GetRFQItems.as_view(), name="get-rfq-items"),
    path('rfq-item/<int:rfq_item_id>/attachments/upload/', views.UploadRFQItemAttachment.as_view(), name="upload-rfq-item-attachment"),
    path('rfq-item/<int:rfq_item_id>/attachments/', views.GetRFQItemAttachments.as_view(), name="list-rfq-item-attachments"),
    path('rfq-attachment/<int:attachment_id>/', views.DeleteRFQItemAttachment.as_view(), name="delete-rfq-item-attachment"),
    path('rfq-attachment/<int:attachment_id>/download/', views.DownloadRFQItemAttachment.as_view(), name="download-rfq-item-attachment"),
    ...
    path('get-rfq-response/<int:rfq_id>/<str:supplier_id>/', views.GetRFQResponsePageData.as_view(),name="get-rfq-response"),
    ...
    path('subscription-status/', views.GetSubscriptionStatus.as_view(), name="subscription-status"),
]
